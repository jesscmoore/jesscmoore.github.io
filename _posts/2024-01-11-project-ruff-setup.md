...
2. `pre-commit install` - to add your pre-commit configuration to your project.
3. Then edit a file, `git add ...` and `git commit ...` to test the ruff hook is working.

### Add make rules (optional)

4. `vim Makefile` - optionally add make rules for common commands.
